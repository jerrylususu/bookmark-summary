...
URL Source: https://duckdb.org/2025/08/08/spatial-joins.html

Published Time: 2025-08-08T00:00:00+00:00

Markdown Content:
![Image 1: Author Avatar](https://duckdb.org/images/blog/authors/max_gabrielsson.jpg)

Max Gabrielsson

2025-08-08· 22 min

_TL;DR: DuckDB v1.3.0 significantly improved the scalability of geospatial joins with a dedicated `SPATIAL\_JOIN` operator._

[Introduction](https://duckdb.org/2025/08/08/spatial-joins.html#introduction)
-----------------------------------------------------------------------------
...
Ever since its inception, DuckDB's `spatial` extension has provided a `GEOMETRY` column type to represent locations, regions and shapes, along with plenty of _spatial predicate_ functions to use when `JOIN`ing. However, it wasn't until recently in [DuckDB v1.3.0](https://duckdb.org/2025/05/21/announcing-duckdb-130.html) that spatial joins really became _scalable_ thanks to the introduction of the dedicated `SPATIAL_JOIN` query **operator**.
...
[What Does a Spatial Join Look Like Again?](https://duckdb.org/2025/08/08/spatial-joins.html#what-does-a-spatial-join-look-like-again)
--------------------------------------------------------------------------------------------------------------------------------------
...
[How DuckDB (Used to) Do Spatial Joins](https://duckdb.org/2025/08/08/spatial-joins.html#how-duckdb-used-to-do-spatial-joins)
-----------------------------------------------------------------------------------------------------------------------------

### [Spatial Predicates](https://duckdb.org/2025/08/08/spatial-joins.html#spatial-predicates)
...
### [Optimization Challenges](https://duckdb.org/2025/08/08/spatial-joins.html#optimization-challenges)
...
### [Complexity Challenges](https://duckdb.org/2025/08/08/spatial-joins.html#complexity-challenges)
...
### [Experiment](https://duckdb.org/2025/08/08/spatial-joins.html#experiment)
...
### [The IE-Join Optimization](https://duckdb.org/2025/08/08/spatial-joins.html#the-ie-join-optimization)
...
Since evaluating the spatial predicate function itself is so expensive, its a good idea to try to do some _cheap_ filtering of potential join matches first in order to reduce the number of pairs that actually need to go through the precise spatial relationship check. Luckily for us, it is relatively easy to do this for most spatial predicates since they all have a common property. Almost all spatial predicates _imply_ _intersection_ in some way, and **if two geometries intersect, their bounding boxes must also intersect**.

The _bounding box_, sometimes called _minimum bounding rectangle_ (MBR) of a geometry is the smallest rectangle that fully contains the geometry. Because bounding boxes basically represent the minimum and maximum x and y coordinates of all vertices in the geometry, they are relatively efficient to compute by just scanning over the geometry a single pass. Additionally, checking if two bounding boxes intersect is also very cheap, as it can be done in constant time with a few simple less-than and greater-than comparisons.
...
[The Spatial Join Operator](https://duckdb.org/2025/08/08/spatial-joins.html#the-spatial-join-operator)
-------------------------------------------------------------------------------------------------------

### [R-Tree Indexing](https://duckdb.org/2025/08/08/spatial-joins.html#r-tree-indexing)
...
### [Joining with R-Trees](https://duckdb.org/2025/08/08/spatial-joins.html#joining-with-r-trees)
...
### [Experiment](https://duckdb.org/2025/08/08/spatial-joins.html#experiment-1)
...
[Limitations and Future work](https://duckdb.org/2025/08/08/spatial-joins.html#limitations-and-future-work)
-----------------------------------------------------------------------------------------------------------
...
### [Larger-Than-Memory Build Sides](https://duckdb.org/2025/08/08/spatial-joins.html#larger-than-memory-build-sides)
...
### [Increased Parallelism](https://duckdb.org/2025/08/08/spatial-joins.html#increased-parallelism)
...
### [Faster Predicate Functions](https://duckdb.org/2025/08/08/spatial-joins.html#faster-predicate-functions)
...
### [Advanced Join Conditions](https://duckdb.org/2025/08/08/spatial-joins.html#advanced-join-conditions)
...
### [`ANTI` / `SEMI` Joins](https://duckdb.org/2025/08/08/spatial-joins.html#anti--semi-joins)
...
[Conclusion](https://duckdb.org/2025/08/08/spatial-joins.html#conclusion)
-------------------------------------------------------------------------
